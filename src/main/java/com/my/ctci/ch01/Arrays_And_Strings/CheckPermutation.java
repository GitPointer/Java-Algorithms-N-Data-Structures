...
public class CheckPermutation {
	 ...
	 * This utilize the definition of a permutation-2 words with the same characters counts
	 * To implement this we assumed that the characters is ASCII and only 128 possible characters
	 * are there. 
	 * 
	 * Time Complexity: O(n)
	 */
